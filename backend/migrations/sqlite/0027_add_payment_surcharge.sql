...
ALTER TABLE als_payment_records ADD COLUMN fee_minor INTEGER NOT NULL DEFAULT 0;

INSERT OR IGNORE INTO als_global_template_vars (var_key, var_value, description) VALUES
