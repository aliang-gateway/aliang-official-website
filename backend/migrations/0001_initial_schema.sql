...
CREATE TABLE IF NOT EXISTS tier_default_items (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX IF NOT EXISTS idx_usage_records_service_item_id ON usage_records(service_item_id);
CREATE INDEX IF NOT EXISTS idx_usage_records_timestamp ON usage_records(usage_timestamp);
